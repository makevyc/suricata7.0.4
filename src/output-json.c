...
int OutputJSONBuffer(json_t *js, LogFileCtx *file_ctx, MemBuffer **buffer, ThreadVars *tv)
{
    ...
    LogFileWrite(file_ctx, *buffer, tv);
    return 0;
}

int OutputJsonBuilderBuffer(JsonBuilder *js, OutputJsonThreadCtx *ctx, ThreadVars *tv)
{
